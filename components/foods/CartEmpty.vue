<template>
  <div class="text-center">
    ...
    <p class="mt-1 text-sm text-gray-500">
      Commencer par sélectionner un produit de la carte
    </p>
  </div>
</template>
